...
#ストロークが*か*-*か#のときにKeyErrorを出すよ    
    ...
    listvowel = ["","O","I","OE","Ie","OI","e","E","Ee","OIE"]
    listvowel2 = ["","O","I","E","e","OI","Ie","OE","Ee","OIE"]
    ...
    def Make(Conso,Ys,Vowel):
        ...
        if not Conso and not Ys and not Vowel:
            ...
            if Ys:
                #Yが入力されていたら
                output = kana2[listconsonant.index(Conso)][listvowel2.index(Vowel)]
            else:
                #そうでないとき
