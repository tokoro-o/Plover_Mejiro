...
def lookup(key):
    ...
    めいし = ["こ","た","と","き","も","は"]
    助詞 = ["","の","で","が","を","に","は","も"]
    名詞 = ["こと","ため","ところ","とき","もの","はなし"]

    どうし = ["","い","す","あ","な","だ","で","ゆ"]
    動詞 = [["","ない","た","ます","ました","なかった","ません","ませんでした"],
          ["いる","いない","いた","います","いました","いなかった","いません","いませんでした"],
          ["する","しない","した","します","しました","しなかった","しません","しませんでした"],
          ["ある","ない","あった","あります","ありました","なかった","ありません","ありませんでした"],
          ["なる","ならない","なった","なります","なりました","ならなかった","なりません","なりませんでした"],
          ["だ","ではない","だった","です","でした","ではなかった","ではありません","ではありませんでした"],
          ["できる","できない","できた","できます","できました","できなかった","できません","できませんでした"],
          ["いう","いわない","いった","いいます","いいました","いわなかった","いいません","いいませんでした"]]
